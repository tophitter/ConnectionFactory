<?php
    ...
    class EnumSet implements Iterator, Countable {
         ...
         */
        public function getEnumClass() { return $this->getEnumeration(); }

        /**
         * Get the classname of the enumeration
         * @return string
         */
        public function getEnumeration() { return $this->enumeration; }
         ...
         * @return int
         */
        public function key() { return $this->ordinal; }
         ...
         * @return boolean
         */
        public function valid() { return $this->ordinal !== $this->ordinalMax && $this->getBit($this->ordinal); }
         ...
         */
        public function getBitset() { return strrev($this->bitset); }
         ...
         * @return boolean
         */
        private function getBit($ordinal) { return (ord($this->bitset[(int) ($ordinal / 8)]) & 1 << ($ordinal % 8)) !== 0; }
